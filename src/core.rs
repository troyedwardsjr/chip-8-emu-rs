...
pub struct Emu {
  screen: [bool; SCREEN_WIDTH * SCREEN_HEIGHT], // Screen
  pc: u16, // Program Counter - Special register: Index of the current instruction
  ram: [u8; RAM_SIZE], // RAM
  v_reg: [u8; NUM_REGS], // V registers,
  i_reg: u16, // I register - RAM index for reads and writes,
